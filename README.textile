...
@sh -c "$(curl -fsSL https://raw.githubusercontent.com/Wing924/simple-light-shell/master/tools/install.sh)"@

h4. via @wget@:

@sh -c "$(wget https://raw.githubusercontent.com/Wing924/simple-light-shell/master/tools/install.sh -O -)"@
...
@curl -L https://raw.githubusercontent.com/Wing924/simple-light-shell/master/tools/install.sh | ZSH=~/.dotfiles/zsh sh@
